...
import com.codeops.registry.config.RequestCorrelationFilter;
...
/**
 * Configures Spring Security for the CodeOps Registry API with stateless JWT-based authentication.
 *
