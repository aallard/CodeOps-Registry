...
/**
 * Configures the asynchronous task execution infrastructure for the Registry service.
 *
 * <p>Provides a {@link ThreadPoolTaskExecutor} with a core pool of 2 threads, a maximum of 10,
 * and a queue capacity of 100. Threads are named with the {@code registry-async-} prefix.
...
public class AsyncConfig implements AsyncConfigurer {
    ...
    public Executor getAsyncExecutor() {
        ...
        executor.setThreadNamePrefix("registry-async-");
